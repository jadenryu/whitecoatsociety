            ...
            <div className="mt-6">
              ...
              <div className="mt-6 grid grid-cols-2 gap-3">
                ...
                <button className="flex justify-center items-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white hover:bg-gray-50">
                  ...
                  <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M12.152,6.896c-0.948,0-2.415-1.078-3.96-1.04c-2.04,0.027-3.913,1.183-4.962,3.007c-2.12,3.675-0.546,9.103,1.519,12.1c1.013,1.454,2.208,3.09,3.792,3.039c1.52-0.065,2.09-0.987,3.935-0.987c1.831,0,2.35,0.987,3.96,0.948c1.637-0.026,2.676-1.48,3.676-2.948c1.156-1.688,1.636-3.325,1.662-3.415c-0.04-0.013-3.182-1.221-3.22-4.857c-0.026-3.04,2.48-4.494,2.597-4.559c-1.429-2.09-3.623-2.324-4.39-2.376C14.641,5.773,13.068,6.896,12.152,6.896z M15.629,3.039c0.817-1.013,1.377-2.415,1.221-3.806c-1.182,0.052-2.61,0.78-3.467,1.78c-0.754,0.884-1.43,2.307-1.248,3.661C13.445,4.834,14.817,4.039,15.629,3.039z" />
                  </svg>
                </button>
              </div>
            </div>
